...
function getParams(): object {
  ...
  try {
    debug("Carregando conteúdo de '{$params['pagina']}'.");
    $obj->content = isset($params['pagina']) ? file_get_contents($params['pagina']) : null;
    debugOk();
  ...
  if(isset($params['emails']) && is_readable($params['emails'])) {
    debugLn("Carregando destinatários da lista '{$params['emails']}'.");
    $fhandle = fopen($params['emails'], 'r');
    while(!feof($fhandle)) {
